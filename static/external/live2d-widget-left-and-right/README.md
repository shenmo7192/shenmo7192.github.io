...
```xml
<link rel="stylesheet" href="https://shenmo7192.gitee.io/live2d-widget-left-and-right/fontawesome/css/all.min.css">
```
...
```xml
<script src="https://shenmo7192.gitee.io/live2d-widget-left-and-right/autoload.js"></script>
```
...
- 如果你能够通过 `ssh` 访问你的主机，请把整个仓库克隆到服务器上。执行：
  ...
  git clone https://gitee.com/shenmo7192/live2d-widget-left-and-right
  ```
