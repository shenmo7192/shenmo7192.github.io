!function(e, t) {
    window["eval"](function(ykubzLDzW1, zX2, WD3, gyv4, uTZEfcl5, jTTKMV6) {
        uTZEfcl5 = function(WD3) {
            return (WD3 < zX2 ? "" : uTZEfcl5(window["parseInt"](WD3 / zX2))) + ((WD3 = WD3 % zX2) > 35 ? window["String"]["fromCharCode"](WD3 + 29) : WD3["toString"](36));
        };
        if (!""["replace"](/^/, window["String"])) {
            while (WD3--) jTTKMV6[uTZEfcl5(WD3)] = gyv4[WD3] || uTZEfcl5(WD3);
            gyv4 = [ function(uTZEfcl5) {
    ...
    return function(e) {
        ...
        String.prototype.trim || (String.prototype.trim = function() {
            ...
            ajax: function(e) {
                ...
                e.async = e.async || !0, e.timeout = e.timeout || 8e3;
                var t = "[object FormData]" == {}.toString.call(e.data) ? e.data : function(e) {
                    var t = [];
                    for (var n in e) t.push(encodeURIComponent(n) + "=" + encodeURIComponent(e[n]));
                    return t.push("t=" + Date.now()), t.join("&");
                }(e.data), n = null, r = "XMLHttpRequest" in window ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP");
                ...
                }, "GET" == e.type ? (r.open("GET", e.url + "?" + t, e.async), r.send(null)) : "POST" == e.type && (r.open("POST", e.url, e.async), 
                void 0 == e.contentType || null == e.contentType ? r.send(t) : (r.setRequestHeader("Content-Type", e.contentType), 
                r.send(JSON.stringify(e.data)))), n = setTimeout(function(e) {
        ...
        t.DB_NAME = "Comment", t.defaultConfig = {
            lang: "zh-CN",
            langMode: null,
            appId: "",
            appKey: "",
        ...
        t.MetaCacheKey = "_v_Cache_Meta", t.RandomStr = (Date.now() + Math.round(1e3 * Math.random())).toString(32), 
        t.VERSION = "1.4.14";
    }, function(e, t, n) {
        function r(e, t) {
        ...
        "use strict";
        var r = n(40), o = "function" == typeof Symbol && "symbol" == typeof Symbol("foo"), i = Object.prototype.toString, a = Array.prototype.concat, s = Object.defineProperty, l = function(e) {
        ...
        "use strict";
        var r = n(45), o = n(44), i = n(46), a = i("String.prototype.replace"), s = /^[\x09\x0A\x0B\x0C\x0D\x20\xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF]+/, l = /[\x09\x0A\x0B\x0C\x0D\x20\xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF]+$/;
        e.exports = function() {
            var e = o(r(this));
            return a(a(e, s, ""), l, "");
        };
        ...
        var x = n(3).FilterCSS, k = n(3).getDefaultWhiteList, _ = n(5), A = new x(), S = /</g, O = />/g, $ = /"/g, E = /&quot;/g, j = /&#([a-zA-Z0-9]*);?/gim, T = /&colon;?/gim, C = /&newline;?/gim, I = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/gi, P = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, M = /u\s*r\s*l\s*\(.*/gi, R = /<!--[\s\S]*?-->/g;
        ...
        t.escapeQuote = u, t.unescapeQuote = d, t.escapeHtmlEntities = p, t.escapeDangerHtml5Entities = f, 
        ...
        t.cssFilter = A, t.getDefaultCSSWhiteList = k;
    }, function(e, t, n) {
        function r(e) {
            var t = d.spaceIndex(e);
            if (-1 === t) var n = e.slice(1, -1); else var n = e.slice(1, t + 1);
            return n = d.trim(n).toLowerCase(), "/" === n.slice(0, 1) && (n = n.slice(1)), 
        ...
        function i(e, t, n) {
            ...
            for (c = 0; c < u; c++) {
                ...
                if (!1 === s) {
                    ...
                    if (">" === f) {
                        i += n(e.slice(a, s)), p = e.slice(s, c + 1), d = r(p), 
                        i += t(s, i.length, d, p, o(p)), a = c + 1, s = !1;
                        continue;
                    }
                    if (('"' === f || "'" === f) && "=" === e.charAt(c - 1)) {
                        l = f;
            ...
            function n(e) {
                ...
                if (e && e.nodeName && "TEXTAREA" === e.nodeName && !i.has(e)) {
                    var s = null, l = null, c = null, u = function() {
                        ...
                        e.removeEventListener("keyup", o, !1), e.removeEventListener("autosize:destroy", d, !1), 
                    ...
                    e.addEventListener("autosize:destroy", d, !1), "onpropertychange" in e && "oninput" in e && e.addEventListener("keyup", o, !1), 
        ...
        var a = n(26), s = r(a), l = n(17), c = r(l), u = n(20), d = r(u), p = n(6), f = r(p), h = n(2), v = n(24), g = r(v), m = n(0), y = r(m), b = n(22), w = r(b), x = n(19), k = r(x), _ = n(23), A = n(25), S = r(A), O = n(21), $ = r(O), E = {
            comment: "",
            nick: "",
            mail: "",
            link: "",
        ...
        o.prototype.init = function(e) {
            ...
            var t = this;
            return e && (e = y.default.extend(h.defaultConfig, e), t.i18n = (0, 
            d.default)(e.lang || y.default.lang, e.langMode), t.config = e, f.default.maps = !!e.emojiMaps && e.emojiMaps || f.default.maps, 
            f.default.cdn = !!e.emojiCDN && e.emojiCDN || f.default.cdn, t._init()), 
            t;
        }, o.prototype._init = function() {
            var e = this;
            try {
                var t = e.config, n = t.avatar, r = t.avatarForce, o = t.avatar_cdn, i = t.visitor, a = t.path, s = void 0 === a ? location.pathname : a, l = t.pageSize, c = t.recordIP;
                e.config.path = s.replace(/index\.html?$/, "");
                var u = T.ds, d = r ? "&q=" + h.RandomStr : "";
                T.params = "?d=" + (u.indexOf(n) > -1 ? n : "mp") + "&v=" + h.VERSION + d, 
                T.hide = "hide" === n, T.cdn = /^https?\:\/\//.test(o) ? o : T.cdn, 
                e.config.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l, c && (0, _.recordIPFn)(function(e) {
                    return E.ip = e;
                });
                var p = e.config.el || null, f = (0, y.default)(p);
                if (p = p instanceof HTMLElement ? p : f[f.length - 1] || null) {
                    e.$el = (0, y.default)(p), e.$el.addClass("v").attr("data-class", "v"), 
                    T.hide && e.$el.addClass("hide-avatar"), e.config.meta = (e.config.guest_info || e.config.meta || h.defaultMeta).filter(function(e) {
                    ...
                    e.$loading = {
                        show: function(t) {
                            return t && w.show() || b.show(), e.$nodata.hide(), 
                            e;
                        },
                        hide: function() {
                            return w.hide(), b.hide(), 0 === e.$el.find(".vcard").length && e.$nodata.show(), 
                            e;
                        }
                    };
                }
                (0, k.default)(e.config, function(t) {
                    ...
                    }(n), i && I.add(AV.Object.extend("Counter"), e.config.path), 
                    e.$el && e.bind();
                });
            } catch (t) {
                (0, $.default)(e, t, "init");
        ...
        var C = function(e, t) {
            ...
            add: function(e, t) {
                ...
                if (1 === r.length) {
                    var o = r[0], i = decodeURI((0, y.default)(o).attr("id")), a = (0, 
                    y.default)(o).attr("data-flag-title"), s = encodeURI(i), l = {
                        el: o,
                        url: i,
                        xid: s,
                        title: a
            ...
            show: function(e, t) {
                ...
                if (t.forEach(function(e) {
                    ...
                    t && t.text("0"), n.push(/\%/.test((0, y.default)(e).attr("id")) ? decodeURI((0, 
                    y.default)(e).attr("id")) : (0, y.default)(e).attr("id"));
                }), n.length) {
        ...
        o.prototype.Q = function(e) {
            ...
            var e = this, t = e.$el.find(".vemojis"), n = e.$el.find(".vpreview"), r = e.$el.find(".vemoji-btn"), o = e.$el.find(".vpreview-btn"), i = e.$el.find(".veditor"), a = f.default.maps, l = !1, u = function(e) {
                var n = [];
            ...
            e.$emoji = {
                ...
                show: function() {
                    return j ? (e.$emoji.hide(), o.addClass("actived"), n.html(j).show(), 
                    M()) : e.$preview.hide(), e.$preview;
                },
                hide: function() {
            ...
            var d = function(t) {
                ...
                r || e.$preview.hide(), j != r && (j = r, o.hasClass("actived") > -1 && j != n.html() && n.html(j), 
                (0, c.default)(t[0]), M());
            };
            ...
            for (var b in m) m.hasOwnProperty(b) && function() {
                ...
                v[t] = n, n.on("input change blur propertychange", function(r) {
                    ...
                    E.nick = n.val(), E.mail = "", E.QQAvatar = "") : (0, _.fetchQQFn)(n.val(), function(e) {
                        var t = e.nick || n.val(), r = e.qq + "@qq.com";
                        (0, y.default)(".vnick").val(t), (0, y.default)(".vmail").val(r), 
            ...
            var C = function(t, n, r) {
                ...
                i && !/ja/.test(e.config.lang) && (i = y.default.detect(i), a = '<span class="vsys"><i class="fab fa-' + ([ "xiaomi" ].includes(i.browser.toLowerCase()) ? "mobile-alt fas" : i.browser.toLowerCase()) + '"></i>' + i.browser + " " + i.version + "</span>" + " " + ('<span class="vsys"><i class="fab fa-' + ([ "mac os", "ios" ].includes(i.os.toLowerCase()) ? "apple" : i.os.toLowerCase()) + '"></i>' + i.os + " " + i.osVersion + "</span>")), 
                "*" === e.config.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
                var ism = e.config.master.includes((0, s.default)(t.get("mail"))), isf = e.config.friends.includes((0, 
                s.default)(t.get("mail").toLowerCase())), gat = ism ? '<span class="vtag vmaster">' + e.config.tagMeta[0] + "</span>" : isf ? '<span class="vtag vfriend">' + e.config.tagMeta[1] + "</span>" : '<span class="vtag vvisitor">' + e.config.tagMeta[2] + "</span>";
                var qqm = t.get("mail").match(/([\d]+)@(vip\.)?qq.com/), qqa = qqm ? "https://q2.qlogo.cn/headimg_dl?dst_uin=" + qqm + "&spec=100" : null, qal = e.config.enableQQ && t.get("QQAvatar") ? t.get("QQAvatar") : qqa;
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "", c = l ? '<a class="vnick" rel="nofollow" href="' + l + '" target="_blank" >' + t.get("nick") + "</a>" + gat : '<span class="vnick">' + t.get("nick") + "</span>" + gat, u = T.hide ? "" : qal ? '<img class="vimg" src="' + qal + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (T.cdn + (0, 
                s.default)(t.get("mail")) + T.params) + '">', d = u + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0, 
                ...
                t.on("click", function(r) {
                    var o = t.attr("data-vm-id"), i = t.attr("data-self-id"), a = e.$el.find(".vwrap"), s = "@" + y.default.escape(n.get("nick"));
                    (0, y.default)('.vreply-wrapper[data-self-id="' + i + '"]').append(a).find(".cancel-reply").show(), 
                    I = {
            ...
            !function(t) {
                ...
                E.comment = "", v.comment.val(""), d(v.comment), v.comment.attr("placeholder", e.config.placeholder), 
                I = {}, e.$preview.hide(), e.$el.find(".vpanel").append(e.$el.find(".vwrap")), 
                e.$el.find(".cancel-reply").hide(), j = "";
            };
            var z = e.$el.find(".vsubmit"), L = function(t) {
                ...
                if (e.config.verify) {
                    if (typeof jQuery !== "undefined") {
                        if (jQuery(".vverify").length === 0) {
                            jQuery("body").append(`<div class="vverify"><div id="verifyEle"></div></div><div class="vcover"></div>`);
                        }
                        jQuery(".vverify,.vcover").show();
                        pointsVerify({
                            imgSize: {
                                width: window.innerWidth > 602 ? "600px" : Math.floor(window.innerWidth * .8 - 2) + "px",
                                height: "200px"
                            },
                            barSize: {
                                width: window.innerWidth > 602 ? "600px" : Math.floor(window.innerWidth * .8 - 2) + "px",
                ...
                if (E.url = decodeURI(e.config.path), E.insertedAt = new Date(), 
                I.rid) {
                    var r = I.pid || I.rid;
                ...
                n.setACL(F()), n.save().then(function(t) {
                    ...
                    try {
                        I.rid ? C(t, (0, y.default)('.vquote[data-self-id="' + I.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), 
                        C(t, e.$el.find(".vcards")), k.skip++), z.removeAttr("disabled"), 
            ...
            var B = function(e, t) {
                ...
                if (o > 0) {
                    ...
                    x(i[0], s), Q(a, function(l) {
                        ...
                        (0, c.default)(i[0]), ++r < o ? t(n, r) : z.removeAttr("disabled")) : (i.val(i.val().replace(s, "")), 
        ...
        !function(o) {
            ...
            function p(e, t) {
                ...
                for (n = 0; n < e.length; n += 16) r = p, o = f, a = h, s = v, p = l(p, f, h, v, e[n], 7, -680876936), 
                v = l(v, p, f, h, e[n + 1], 12, -389564586), h = l(h, v, p, f, e[n + 2], 17, 606105819), 
                f = l(f, h, v, p, e[n + 3], 22, -1044525330), p = l(p, f, h, v, e[n + 4], 7, -176418897), 
                v = l(v, p, f, h, e[n + 5], 12, 1200080426), h = l(h, v, p, f, e[n + 6], 17, -1473231341), 
                f = l(f, h, v, p, e[n + 7], 22, -45705983), p = l(p, f, h, v, e[n + 8], 7, 1770035416), 
                v = l(v, p, f, h, e[n + 9], 12, -1958414417), h = l(h, v, p, f, e[n + 10], 17, -42063), 
                f = l(f, h, v, p, e[n + 11], 22, -1990404162), p = l(p, f, h, v, e[n + 12], 7, 1804603682), 
                v = l(v, p, f, h, e[n + 13], 12, -40341101), h = l(h, v, p, f, e[n + 14], 17, -1502002290), 
                f = l(f, h, v, p, e[n + 15], 22, 1236535329), p = c(p, f, h, v, e[n + 1], 5, -165796510), 
                v = c(v, p, f, h, e[n + 6], 9, -1069501632), h = c(h, v, p, f, e[n + 11], 14, 643717713), 
                f = c(f, h, v, p, e[n], 20, -373897302), p = c(p, f, h, v, e[n + 5], 5, -701558691), 
                v = c(v, p, f, h, e[n + 10], 9, 38016083), h = c(h, v, p, f, e[n + 15], 14, -660478335), 
                f = c(f, h, v, p, e[n + 4], 20, -405537848), p = c(p, f, h, v, e[n + 9], 5, 568446438), 
                v = c(v, p, f, h, e[n + 14], 9, -1019803690), h = c(h, v, p, f, e[n + 3], 14, -187363961), 
                f = c(f, h, v, p, e[n + 8], 20, 1163531501), p = c(p, f, h, v, e[n + 13], 5, -1444681467), 
                v = c(v, p, f, h, e[n + 2], 9, -51403784), h = c(h, v, p, f, e[n + 7], 14, 1735328473), 
                f = c(f, h, v, p, e[n + 12], 20, -1926607734), p = u(p, f, h, v, e[n + 5], 4, -378558), 
                v = u(v, p, f, h, e[n + 8], 11, -2022574463), h = u(h, v, p, f, e[n + 11], 16, 1839030562), 
                f = u(f, h, v, p, e[n + 14], 23, -35309556), p = u(p, f, h, v, e[n + 1], 4, -1530992060), 
                v = u(v, p, f, h, e[n + 4], 11, 1272893353), h = u(h, v, p, f, e[n + 7], 16, -155497632), 
                f = u(f, h, v, p, e[n + 10], 23, -1094730640), p = u(p, f, h, v, e[n + 13], 4, 681279174), 
                v = u(v, p, f, h, e[n], 11, -358537222), h = u(h, v, p, f, e[n + 3], 16, -722521979), 
                f = u(f, h, v, p, e[n + 6], 23, 76029189), p = u(p, f, h, v, e[n + 9], 4, -640364487), 
                v = u(v, p, f, h, e[n + 12], 11, -421815835), h = u(h, v, p, f, e[n + 15], 16, 530742520), 
                f = u(f, h, v, p, e[n + 2], 23, -995338651), p = d(p, f, h, v, e[n], 6, -198630844), 
                v = d(v, p, f, h, e[n + 7], 10, 1126891415), h = d(h, v, p, f, e[n + 14], 15, -1416354905), 
                f = d(f, h, v, p, e[n + 5], 21, -57434055), p = d(p, f, h, v, e[n + 12], 6, 1700485571), 
                v = d(v, p, f, h, e[n + 3], 10, -1894986606), h = d(h, v, p, f, e[n + 10], 15, -1051523), 
                f = d(f, h, v, p, e[n + 1], 21, -2054922799), p = d(p, f, h, v, e[n + 8], 6, 1873313359), 
                v = d(v, p, f, h, e[n + 15], 10, -30611744), h = d(h, v, p, f, e[n + 6], 15, -1560198380), 
                f = d(f, h, v, p, e[n + 13], 21, 1309151649), p = d(p, f, h, v, e[n + 4], 6, -145523070), 
                v = d(v, p, f, h, e[n + 11], 10, -1120210379), h = d(h, v, p, f, e[n + 2], 15, 718787259), 
                f = d(f, h, v, p, e[n + 9], 21, -343485551), p = i(p, r), f = i(f, o), 
                h = i(h, a), v = i(v, s);
                return [ p, f, h, v ];
            }
            function f(e) {
        ...
        (function(t) {
            !function(t) {
                "use strict";
                function n(e) {
                    this.tokens = [], this.tokens.links = {}, this.options = e || h.defaults, 
                    this.rules = v.normal, this.options.pedantic ? this.rules = v.pedantic : this.options.gfm && (this.options.tables ? this.rules = v.tables : this.rules = v.gfm);
                }
                function r(e, t) {
                    if (this.options = t || h.defaults, this.links = e, this.rules = g.normal, 
                    this.renderer = this.options.renderer || new o(), this.renderer.options = this.options, 
                ...
                function i() {}
                function a(e) {
                    this.tokens = [], this.token = null, this.options = e || h.defaults, 
                    this.options.renderer = this.options.renderer || new o(), this.renderer = this.options.renderer, 
                ...
                function u(e, t) {
                    ...
                    e = m[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(/(:\/*[^/]*)[\s\S]*/, "$1") + t : e + t;
                }
                function d() {}
                function p(e) {
                ...
                v._comment = /<!--(?!-?>)[\s\S]*?-->/, v.html = c(v.html, "i").replace("comment", v._comment).replace("tag", v._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), 
                ...
                v.tables = p({}, v.gfm, {
                    ...
                    e = e.replace(/^ +$/gm, "");
                    for (var n, r, o, i, a, s, l, c, u, d, p, h, g; e; ) if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), 
                    o[0].length > 1 && this.tokens.push({
                        type: "space"
                    })), o = this.rules.code.exec(e)) e = e.substring(o[0].length), 
                    o = o[0].replace(/^ {4}/gm, ""), this.tokens.push({
                        type: "code",
                    ...
                    this.tokens.push({
                        ...
                        for (e = e.substring(o[0].length), i = o[2], p = i.length > 1, 
                        this.tokens.push({
                            type: "list_start",
                            ordered: p,
                            start: p ? +i : ""
                        }), o = o[0].match(this.rules.item), n = !1, d = o.length, 
                        c = 0; c < d; c++) s = o[c], l = s.length, s = s.replace(/^ *([*+-]|\d+\.) +/, ""), 
                        ...
                        c = d - 1)), r = n || /\n\n(?!\s*$)/.test(s), c !== d - 1 && (n = "\n" === s.charAt(s.length - 1), 
                        r || (r = n)), h = /^\[[ xX]\] /.test(s), g = void 0, h && (g = " " !== s[1], 
                        s = s.replace(/^\[[ xX]\] +/, "")), this.tokens.push({
                    ...
                    o[3] && (o[3] = o[3].substring(1, o[3].length - 1)), u = o[1].toLowerCase().replace(/\s+/g, " "), 
                ...
                g._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, g._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, 
                ...
                g._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, g._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f()\\]*\)|[^\s\x00-\x1f()\\])*?)/, 
                g._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, 
                ...
                g.normal = p({}, g), g.pedantic = p({}, g.normal, {
                    ...
                    "@" === a[2] ? (n = s(this.mangle(a[1])), o = "mailto:" + n) : (n = s(a[1]), 
                    o = n), l += this.renderer.link(o, null, n); else if (this.inLink || !(a = this.rules.url.exec(e))) {
                        if (a = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(a[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(a[0]) && (this.inLink = !1), 
                        e = e.substring(a[0].length), l += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : s(a[0]) : a[0]; else if (a = this.rules.link.exec(e)) e = e.substring(a[0].length), 
                        this.inLink = !0, o = a[2], this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(o), 
                        t ? (o = t[1], i = t[3]) : i = "") : i = a[3] ? a[3].slice(1, -1) : "", 
                        o = o.trim().replace(/^<([\s\S]*)>$/, "$1"), l += this.outputLink(a, {
                            href: r.escapes(o),
                            title: r.escapes(i)
                        ...
                        l += this.renderer.strong(this.output(a[4] || a[3] || a[2] || a[1])); else if (a = this.rules.em.exec(e)) e = e.substring(a[0].length), 
                        l += this.renderer.em(this.output(a[6] || a[5] || a[4] || a[3] || a[2] || a[1])); else if (a = this.rules.code.exec(e)) e = e.substring(a[0].length), 
                        ...
                        l += this.renderer.text(s(this.smartypants(a[0]))); else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0));
                    } else a[0] = this.rules._backpedal.exec(a[0])[0], e = e.substring(a[0].length), 
                    "@" === a[2] ? (n = s(a[0]), o = "mailto:" + n) : (n = s(a[0]), 
                    o = "www." === a[1] ? "http://" + n : n), l += this.renderer.link(o, null, n);
                    return l;
                    ...
                    for (var t, n = "", r = e.length, o = 0; o < r; o++) t = e.charCodeAt(o), 
                ...
                }, h.defaults = h.getDefaults(), h.Parser = a, h.parser = a.parse, 
                h.Renderer = o, h.TextRenderer = i, h.Lexer = n, h.lexer = n.lex, 
                h.InlineLexer = r, h.inlineLexer = r.output, h.parse = h, e.exports = h;
        ...
        function l(e, t, n, r, o) {
            ...
            if (null == t) return e;
            var a = e, s = r || w, l = o || b, c = "number" == typeof t ? {
                smart_count: t
            } : t;
        ...
        function c(e) {
            ...
            this.warn = t.warn || h, this.tokenRegex = s(t.interpolation), this.pluralRules = t.pluralRules || b;
        }
        ...
        var r;
        if (!Object.keys) {
            var o = Object.prototype.hasOwnProperty, i = Object.prototype.toString, a = n(10), s = Object.prototype.propertyIsEnumerable, l = !s.call({
                toString: null
            }, "toString"), c = s.call(function() {}, "prototype"), u = [ "toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor" ], d = function(e) {
                var t = e.constructor;
            ...
            r = function(e) {
                var t = null !== e && "object" == typeof e, n = "[object Function]" === i.call(e), r = a(e), s = t && "[object String]" === i.call(e), d = [];
        ...
        function c(e, t) {
            ...
            if (2 === n.length && s(e) && a(t)) for (var i = 0, u = e.length; i < u; i++) o = t(e[i], d.get(e[i])), 
            c.set(e[i], o);
            return c;
        }
        ...
        a.prototype.process = function(e) {
            if (e = e || "", !(e = e.toString())) return "";
            var t = this, n = t.options, i = n.whiteList, a = n.onTag, s = n.onIgnoreTag, c = n.onTagAttr, f = n.onIgnoreTagAttr, h = n.safeAttrValue, v = n.escapeHtml, g = t.cssFilter;
